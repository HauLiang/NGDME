function [GDest, Modeest] = NGDME(y, T, eGDset, lambda, gamma, tol)
% This code implements the Nonlinear Group Delay Mode Estimation (NGDME) algorithm 
%
...
iternum = 200;  % the maximum allowable iterations
...
%%%%%%%%%%%%%%%% update demodulated signals %%%%%%%%%%%%%%%%%%%%%%%%%%%5
     x = aug_ADMM(A, D, y(:), lambda, 1, 1);  % update X
